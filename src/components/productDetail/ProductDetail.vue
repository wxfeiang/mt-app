        ...
        <div class="food" v-show="showFlag" ref="foodView">
            <div class="food-wrapper">
                ...
                <ul class="rating-wrapper">
                    ...
                    <ul class="rating-contant" v-if="food.rating">
...
import Split from "../split/Split"       // 分割线组件
export default {
  components: {
...
.food .food-wrapper .rating-wrapper .snd-title{
	float: right;
	font-size: 0;
}
.food .food-wrapper .rating-wrapper .snd-title .text,
.food .food-wrapper .rating-wrapper .snd-title .icon
{
	font-size: 13px;
	color: #9D9D9D;
